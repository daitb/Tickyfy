...
export function TransferTicket({ ticketId, orders, onNavigate }: TransferTicketProps) {
  ...
  const transferableTickets: Array<Ticket & { eventTitle: string; eventDate: string; eventVenue: string }> = [];
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-neutral-600">
                        {selectedTicket.tier} • {new Date(selectedTicket.eventDate).toLocaleDateString()}
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <CardContent className="p-4">
                        <div className="space-y-2">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-900">{selectedTicket.tier}</div>
                          </div>
                          <div>
