    ...
    return (
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center">
        <div className="text-center px-4">
          <ShoppingBag className="mx-auto mb-4 text-neutral-300" size={64} strokeWidth={1.5} />
          <h2 className="mb-2">Your cart is empty</h2>
          <p className="text-neutral-600 mb-6 max-w-md mx-auto">
            Start exploring amazing events and add tickets to your cart to get started!
          </p>
          <Button 
              ...
              return (
                <div key={index} className="bg-white rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <Badge className="bg-teal-500">{event?.category}</Badge>
                        </div>
                        <Button
                          variant="ghost"
                          size="icon"
                  ...
                  <div className="bg-neutral-50 rounded-lg p-4 mb-4">
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <p className="text-neutral-900">{formatDate(item.eventDate)}</p>
                      </div>
                      <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-neutral-500 mb-1">Ticket Type</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">Enter it here to get a discount</p>
                </div>
              </div>
