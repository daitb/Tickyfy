...
export function UserProfile({ onNavigate }: UserProfileProps) {
    ...
    if (file) {
      ...
      try {
        ...
        const errorMsg =
          ...
          t("pages.userProfile.uploadAvatarError");
        setError(errorMsg);
        toast.error(errorMsg);
      }
    }
  ...
  const handleSave = async () => {
    try {
      ...
      const errorMsg =
        err.response?.data?.message ||
        t("pages.userProfile.profileUpdateError");
      setError(errorMsg);
      toast.error(errorMsg);
    } finally {
      setIsSaving(false);
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      const errorMsg =
        err.response?.data?.message ||
        t("pages.userProfile.passwordChangeError");
      setError(errorMsg);
      toast.error(errorMsg);
    } finally {
  ...
  const handlePreferencesUpdate = async () => {
    try {
      ...
      setError(
        err.response?.data?.message ||
          t("pages.userProfile.preferencesUpdateError")
      );
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Loader2
            className="mx-auto animate-spin text-purple-600 mb-4"
            size={48}
          />
          <p className="text-gray-600">
            {t("pages.userProfile.loadingProfile")}
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50">
              ...
              <CardContent className="p-6">
                ...
                <div className="text-center mb-6">
                  ...
                  <Badge className="bg-purple-100 text-purple-700">
                    {t("pages.userProfile.regularUser")}
                  </Badge>
                </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="profile" className="mt-0">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="dateOfBirth">
                        {t("pages.userProfile.dateOfBirth")}
                      </Label>
                      <Input
                        id="dateOfBirth"
                        type="date"
                ...
                <Card className="mb-6">
                  <CardHeader>
                    <CardTitle>
                      {t("pages.userProfile.accountStatistics")}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">
                            {t("pages.userProfile.totalBookings")}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-pink-600">
                            {profileStats.totalEventsAttended}
                          </p>
                          <p className="text-xs text-gray-600">
                            {t("pages.userProfile.eventsAttended")}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg col-span-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">
                            {t("pages.userProfile.memberSince")}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <p className="text-xs text-gray-500">
                        💡 <strong>{t("pages.userProfile.roles")}:</strong>{" "}
                        {profileStats.roles.length > 0
                          ? profileStats.roles.join(", ")
                          : "User"}
                      </p>
                    </div>
                  </CardContent>
              ...
              <TabsContent value="security" className="mt-0">
                <h1 className="mb-6">
                  {t("pages.userProfile.securitySettings")}
                </h1>
                  ...
                  <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-red-800 text-sm">
                        {t("pages.userProfile.errorTitle")}
                      </p>
                  ...
                  <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-green-800 text-sm">
                        {t("pages.userProfile.successTitle")}
                      </p>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <div className="relative mt-1.5">
                        <Input
                          ...
                          placeholder={t(
                            "pages.userProfile.currentPasswordPlaceholder"
                          )}
                          className="pr-10"
                        />
                        <button
                    ...
                    <div>
                      ...
                      <div className="relative mt-1.5">
                        <Input
                          ...
                          placeholder={t(
                            "pages.userProfile.newPasswordPlaceholder"
                          )}
                          className="pr-10"
                        />
                        <button
                        ...
                        <div className="mt-2 space-y-1.5">
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-gray-600">
                              {t("userProfile.passwordStrengthLabel")}
                            </span>
                            <span
                          ...
                          <div className="text-xs text-gray-500 space-y-0.5 mt-2">
                            ...
                            >
                              {passwordData.newPassword.length >= 8 ? "✓" : "○"}{" "}
                              {t("pages.userProfile.passwordRequirement8Chars")}
                            </p>
                            <p
                              className={
                            ...
                            >
                              ...
                              /[a-z]/.test(passwordData.newPassword)
                                ? "✓"
                                : "○"}{" "}
                              {t("userProfile.passwordRequirementUpperLower")}
                            </p>
                            <p
                              className={
                            ...
                            >
                              {/[0-9]/.test(passwordData.newPassword)
                                ? "✓"
                                : "○"}{" "}
                              {t("pages.userProfile.passwordRequirementNumber")}
                            </p>
                            <p
                              className={
                            ...
                            >
                              {/[^a-zA-Z0-9]/.test(passwordData.newPassword)
                                ...
                                : "○"}{" "}
                              {t(
                                "pages.userProfile.passwordRequirementSpecial"
                              )}
                            </p>
                          </div>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="relative mt-1.5">
                        <Input
                          ...
                          placeholder={t(
                            "pages.userProfile.confirmPasswordPlaceholder"
                          )}
                          className="pr-10"
                        />
                        <button
                      ...
                      {passwordData.confirmPassword &&
                        passwordData.newPassword !==
                          ...
                          <p className="text-xs text-red-600 mt-1.5">
                            {t("pages.userProfile.passwordMismatch")}
                          </p>
                        )}
                      {passwordData.confirmPassword &&
                        passwordData.newPassword ===
                          ...
                          <p className="text-xs text-green-600 mt-1.5 flex items-center gap-1">
                            <CheckCircle size={12} />{" "}
                            {t("pages.userProfile.passwordMatch")}
                          </p>
                        )}
                    </div>
                    ...
                    <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      <p className="text-sm text-blue-800">
                        <strong>
                          💡 {t("pages.userProfile.passwordNote").split(":")[0]}
                          :
                        </strong>{" "}
                        {t("pages.userProfile.passwordNote").split(":")[1]}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="vi">
                            {t("pages.userProfile.vietnamese")}
                          </SelectItem>
                          <SelectItem value="en">
                            {t("pages.userProfile.english")}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                ...
                <Card className="mb-6">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between py-3 border-b">
                      <div>
                        <p className="font-medium">
                          {t("pages.userProfile.emailNotifications")}
                        </p>
                        <p className="text-sm text-gray-600">
                          {t("pages.userProfile.receiveEmailNotifications")}
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between py-3 border-b">
                      <div>
                        <p className="font-medium">
                          {t("pages.userProfile.pushNotifications")}
                        </p>
                        <p className="text-sm text-gray-600">
                          {t("pages.userProfile.receivePushNotifications")}
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                    ...
                    <div className="flex items-center justify-between py-3">
                      <div>
                        <p className="font-medium">
                          {t("pages.userProfile.marketingEmails")}
                        </p>
                        <p className="text-sm text-gray-600">
                          {t("pages.userProfile.receiveMarketingEmails")}
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <Label htmlFor="profileVisibility">
                        {t("pages.userProfile.profileVisibility")}
                      </Label>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="public">
                            {t("pages.userProfile.profileVisibilityPublic")}
                          </SelectItem>
                          <SelectItem value="private">
                            {t("pages.userProfile.profileVisibilityPrivate")}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div className="pt-4 border-t">
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center gap-2 text-sm">
                          ...
                          />
                          <span>
                            {t("pages.userProfile.showEventsAttending")}
                          </span>
                        </label>
                        <label className="flex items-center gap-2 text-sm">
                          <input
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t("pages.userProfile.deleteAccountTitle")}
            </DialogTitle>
            <DialogDescription>
