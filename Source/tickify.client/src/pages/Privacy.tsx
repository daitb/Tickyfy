        ...
        <div className="bg-card rounded-lg border shadow-sm p-8">
          ...
          <div className="mt-8 p-6 bg-muted rounded-lg">
            <h3 className="text-lg font-bold mb-4">
              {t('privacy.relatedLinks.title', 'Related Information')}
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              >
                ...
                {t('privacy.relatedLinks.terms', 'Terms of Service')}
              </Button>
              <Button
                variant="outline"
                size="sm"
              ...
              >
                ...
                {t('privacy.relatedLinks.refund', 'Refund Policy')}
              </Button>
              <Button
                variant="outline"
                size="sm"
              ...
              >
                ...
                {t('privacy.relatedLinks.helpCenter', 'Help Center')}
              </Button>
              <Button
                variant="outline"
                size="sm"
              ...
              >
                ...
                {t('privacy.relatedLinks.contact', 'Contact Us')}
              </Button>
            </div>
          </div>
